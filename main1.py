...
options.add_argument("--user-data-dir=C:/Users/Thaagam/Documents/whatsappbot/ajith/chromedata")
...
mydb = mysql.connector.connect(
    host="166.62.27.182",
    user="Testing1",
    password="Thaagam@123",
    database="ThaagamWhatsapp"
)
...
def send_photo(phone_no, img_dir, phototext):
  ...
  try:
    ...
    element = WebDriverWait(driver, 10).until(
      lambda x: driver.find_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/div[2]/span/div/span/div/div/div[2]/div/div[1]/div[3]/div/div/div[2]/div[1]/div[1]/p'))
                                            #there
    ptext = driver.find_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/div[2]/span/div/span/div/div/div[2]/div/div[1]/div[3]/div/div/div[2]/div[1]/div[1]/p')
...
if photoyn == True:
  img_dir = filedialog.askopenfilename(initialdir="/", title="Select A File", filetypes=(("all File", ".jpg"),
                                                                                       ("all files", ".")))
...
for i in range(len(df)):
  ...
  print("TOTAL COUNT:", COUNTING)
  print("TOTAL RUN:", COUNTING - skipped)
  sleep(10)
